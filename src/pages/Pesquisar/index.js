  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.containerFilter}>
        <CampoPesquisaFiltro onPressSearchIcon={() => navigation.navigate("Filtros")} onPressFilterIcon={() => {}} />
      </View>
...
const styles = StyleSheet.create({
  ...
  containerFilter: {
    ...
    alignItems: "center",
    marginBottom: 20,
    marginLeft: 10, // Adiciona marginLeft para deslocar o elemento para a direita
  },
  categoriaContainer: {
    marginBottom: 20,
    marginLeft: 10, // Adiciona marginLeft para deslocar o elemento para a direita
